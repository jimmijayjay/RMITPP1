        ...
        <div class="row probootstrap-vh-75 align-items-center text-left">
          <div class="col-sm">
            <div class="probootstrap-text pt-5">
              <h1 class="probootstrap-heading text-white mb-4">Reset Password Email Sent</h1>
              <div class="probootstrap-subheading mb-5">
                <p class="h4 font-weight-normal">An email will be with you shortly.<br>
                Please click the reset password link in the body to reset your password<br>
