<footer class="probootstrap-footer">
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-8">
            <div class="row">
              <div class="col-lg mb-4"><h2 class="probootstrap-heading"><a href="index.php">Car Buddy</a></h2></div>
              <div class="col-lg">
        ...
        <div class="row">
          ...
          <div class="col-md text-md-right text-left">
            <p><small>&copy; InfoTech Development Systems 2019 (RMIT Uni Assigmnet). All Rights Reserved. <br> Made with a <a href="https://uicookies.com/">uiCookies</a> bootstrap template</small></p>
          </div>
        </div>
      </div>
    </footer>