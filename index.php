        ...
        <div class="row probootstrap-vh-100 align-items-center text-center">
          <div class="col-sm">
            <div class="probootstrap-text">
              <h1 class="probootstrap-heading text-white mb-4">Try Car Buddy now.</h1>
              <div class="probootstrap-subheading mb-5">
                <p class="h4 font-weight-normal">Car Buddy allows customers to hire the vehicle of their choice for short trips.</p>
              </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md pr-md-5 pr-0 mb-5">
            <h1 class="mb-4 display-5">More Choice</h1>
          ...
          <div class="col-lg">
            <div class="media mb-md-0 mb-3">
              ...
              <div class="media-body">
                ...
                <p>Multil Layered Password Encryption</p>
              </div>
            </div>
          </div>
          <div class="col-lg">
